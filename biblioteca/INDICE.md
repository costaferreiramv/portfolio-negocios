...
Índice mestre dos posts salvos da coleção **Portfólio Negócios**.
...
Só os posts já analisados aparecem aqui — o tema é atribuído na leitura, não
automaticamente.
...
- [Record a Skill: grava a tela fazendo a tarefa uma vez e ela vira skill](posts/allesinisgalli-record-a-skill.md) — @allesinisgalli · reel · 2026-07-22
...
- [Se o cliente perguntou o preço, responda — e devolva uma pergunta](posts/marcele-corretora-cliente-pergunta-preco.md) — @marcele_corretora · reel · 2026-07-16
- [Duas ligações, mesmo imóvel: o que muda é a energia de quem liga](posts/marcele-corretora-energia-do-vendedor.md) — @marcele_corretora · reel · 2026-07-10
...
Autores com 3 ou mais posts salvos. A lista completa está em `inventario.jsonl`.

| autor | posts |
|---|---|
| @marcele_corretora | 26 |
| @lucasmarrques | 24 |
| @kakarivas | 23 |
| @brunoferoliveira | 21 |
| @brokersbr | 19 |
| @sousasolucoes | 19 |
| @guilhermemachadooficial | 13 |
| @impulso.imobiliario | 13 |
| @jornadatop | 13 |
| @carol.iasmim | 12 |
| @euriler | 12 |
| @leonardo_ura | 12 |
| @nicole.forziati | 12 |
| @thiagoconceroficial | 11 |
| @chaiene.luz | 10 |
| @marthaleonardis | 10 |
| @mpercussor | 10 |
| @natanpimentels | 10 |
...
| @michellymullermkt | 8 |
| @rafaelbem | 8 |
| @bflymarketing.imob | 7 |
| @guilhermexkruger | 7 |
| @keniabittencourtt | 7 |
| @obrunonogueira | 7 |
| @corretormaquinadevendas | 6 |
| @danilobezerraddb | 6 |
| @erikammello | 6 |
| @gabrielpimennta | 6 |
| @marcolang.com.br | 6 |
...
_Autores distintos na coleção: 629._

---

## Pendências

Todo post da coleção já tem arquivo em `posts/` com legenda integral e, quando é
vídeo, a transcrição. O que falta nos marcados como `pendente` é a leitura dos
slides de carrossel e a análise (resumo, pontos-chave, aplicação).
