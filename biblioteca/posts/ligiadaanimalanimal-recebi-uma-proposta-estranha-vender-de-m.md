---
titulo: "Recebi uma proposta estranha vender de meia em meia hora, mesmo se não"
autor: "@ligiadaanimalanimal"
url: https://www.instagram.com/p/C_Koa9asN66/
tipo: video
temas: []
tags: []
duracao: "1min56"
...
Recebi uma proposta estranha: 
"vender de meia em meia hora, mesmo se não tiver conteúdo no perfil".
...
Dia 1 da campanha:
- investimento de 100 reais, faturamento de 400 reais.

Paga-se o tráfego e ainda sobram 300 reais.

Dia 2 da campanha:
- reinveste os 300 reais, faturamento de 1.200 reais.

Paga-se o tráfego e ainda sobram 900 reais. 

Em menos de 1 ano, repetindo esse ciclo,

ela - a Melina ( @demaesparamaes) - está passando de 1 milhão. 
...
Vendendo para público frio (e não para seguidores).

Tudo isso por conta do Roteiro Publicitário™.

Aperte em "baixar" 👇

copie as 4 partes do roteiro

e pare de gastar dinheiro com tráfego pago que não dá retorno.
